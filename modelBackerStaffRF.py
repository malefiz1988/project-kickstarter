...
def createModel(data, scoring='precision', drop_backers_count = False, drop_staff_pick = False):
    ...
    filename = './models/modelBackerStaffRF.sav'
    pickle.dump(rf_model, open(filename, 'wb'))
    print("model saved")
    
    filename = './models/preprocessorBackerStaffRF.sav'
