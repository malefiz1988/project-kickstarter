...
def createModel(data, scoring='precision', drop_backers_count = True, drop_staff_pick = False):
    ...
    filename = './models/modelStaffRF.sav'
    pickle.dump(rf_model, open(filename, 'wb'))
    print("model saved")
    
    filename = './models/preprocessorStaffRF.sav'
